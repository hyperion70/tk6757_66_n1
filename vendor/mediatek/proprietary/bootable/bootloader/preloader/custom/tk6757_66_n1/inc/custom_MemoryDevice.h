...
#define BOARD_ID                MT6757_EVB

#define CS_PART_NUMBER[0]       H9HP52ACPMMDAR
#define CS_PART_NUMBER[1]       KMWX10016M_B619
#define CS_PART_NUMBER[2]       KMWC10016M_B812
#define CS_PART_NUMBER[3]       H9TQ26ADFTBCUR
#define CS_PART_NUMBER[4]       H9HP27ACVUMDAR
#define CS_PART_NUMBER[5]       KMDH6001DM_B422
