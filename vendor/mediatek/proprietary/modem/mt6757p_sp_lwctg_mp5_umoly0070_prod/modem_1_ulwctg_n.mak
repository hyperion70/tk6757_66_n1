...
# Generated at 2015-09-17 11:32:38

IMS_GEN_CFG = GEN91_USER    # Value:NONE
                      # Description:no ims
                      # Value:GEN90_ENG
                      # Description:90 generation eng
                      # Value:GEN90_USER
                      # Description:90 generation user
                      # Value:GEN91_ENG
                      # Description:91 generation eng
                      # Value:GEN91_USER
                      # Description:91 generation user
                      # Value:GEN92_ENG
                      # Description:92 generation eng
                      # Value:GEN92_USER
                      # Description:92 generation user
                      # Value:GEN93_ENG
                      # Description:93 generation eng
                      # Value:GEN93_USER
                      # Description:93 generation user


RSIM_SINGLE_RF_SUPPORT = FALSE     # Value:TRUE
                                   # Description:Support
                                   # Value:FALSE
                                   # Description:Not support


2G_STANDBY_DAC_ENHANCEMENT_ENABLE = FALSE    # Description:
...
2G_MIPI_MULTI_PA_DATA_SUPPORT = FALSE     # Value:TRUE
                                          # Description:2G multi-PA data of MIPI is supported
                                          # Value:FALSE
                                          # Description:2G multi-PA data of MIPI is unsupported


DHL_DISABLE_DATA_OUTPUT = FALSE     # Value:TRUE
                                    # Description:Does not output logging and memory dump.
                                    # Value:FALSE
                                    # Description:Normal logging and dump procedure.


2G_GMSK_EPSK_MIPI_TX_TIMING_OPTIMIZATION_SUPPORT = FALSE     # Value:TRUE
                                                             # Description:2G GMSK/EPSK MIPI TX timing optimization is supported
                                                             # Value:FALSE
                                                             # Description:2G GMSK/EPSK MIPI TX timing optimization is unsupported


MULTIPLE_IMS_SUPPORT = FALSE     # Value:TRUE
                                 # Description:Turn on Muliple IMS feature
                                 # Value:FALSE
                                 # Description:Turn off Muliple IMS feature


LG_WG_SUPPORT = FALSE     # Value:TRUE
                          # Description:Feature is available
                          # Value:FALSE
                          # Description:Feature is not available


MULTIPLE_PS = FALSE     # Value:TRUE
                        # Description:Turn on Muliple PS attach feature
                        # Value:FALSE
                        # Description:Turn off Muliple PS attach feature


UL64QAM_SUPPORT = TRUE    # Value:TRUE
                            # Description:Uplink 64QAM are supported.
                            # Value:FALSE
                            # Description:MD supports only legacy modulation scheme.


LWA_SUPPORT = FALSE     # Value:TRUE
                        # Description:Support LWA
                        # Value:FALSE
                        # Description:Not Support LWA


ABB_TXDAC_CAL_AUXADC2_PULL_LOW = FALSE     # Value:TRUE
                                           # Description:ABB TXDAX CAL AUXADC2 pull low enable
                                           # Value:FALSE
                                           # Description:ABB TXDAX CAL AUXADC2 pull low disable


CHANNEL_LOCK = FALSE     # Description:
...
ABB_TXDAC_CAL_ONLY_IN_FIRST_BOOT = FALSE     # Value:TRUE
                                             # Description:enable this SW work around
                                             # Value:FALSE
                                             # Description:disable this SW work around


LTE_GTT_SUPPORT = FALSE     # Value:TRUE
                            # Description:Enable this feature
                            # Value:FALSE
                            # Description:Disable this feature


2G_ALTERNATIVE_RX_PATH_SUPPORT = FALSE     # Value:TRUE
                                           # Description:2G alternative RX path is supported
                                           # Value:FALSE
                                           # Description:2G alternative RX path is unsupported


LTE_BAND_EXTENSION_SUPPORT = TRUE    # Value:TRUE
                                       # Description:Extended E-UTRA operating band number and corresponding EARFCN numbering space are supported.
                                       # Value:FALSE
                                       # Description:MD supports only legacy (non-extended) E-UTRA operating band number and its EARFCN numbering.


RF_BSI_CLK_DIV_BY_AP_ENABLE = FALSE     # Value:TRUE
                                        # Description:Enable RF BSI clock divider by AP side
                                        # Value:FALSE
                                        # Description:Disable RF BSI clock divider by AP side


EVS_SUPPORT = TRUE    # Value:TRUE
                        # Description:EVS support
                        # Value:FALSE
                        # Description:EVS no support


L1_EXTERNAL_LNA_SUPPORT = FALSE     # Value:TRUE
                                    # Description:External LNA is supported
                                    # Value:FALSE
                                    # Description:External LNA is unsupported


LOG_BUF_IN_SHM_SUPPORT = FALSE     # Value:TRUE
                                   # Description:Enable this feature
                                   # Value:FALSE
                                   # Description:Disable this feature
...
2G_APC_OFF_DELAY_SUPPORT = FALSE     # Value:TRUE
                                     # Description:2G APC Off  Delay is supported
                                     # Value:FALSE
                                     # Description:2G APC Off Delay is unsupported


LTE_REPORT_CAP_AS_RELEASE = AS_REL_10    # Description:
...
SPEECH_WW_OPERATOR_SCORE_ENHANCE = FALSE    # Description:
...
ECALL_SUPPORT = FALSE    # Description:
                         # Enable eCall support
                         # Option Values:
                         # TRUE : Ecall enable
                         # FALSE: Ecall disable
                         # Switch-ability:
...
NVRAM_LID_CHECK = TRUE     # Description:
...
OPEN_DSP_SPEECH_SUPPORT = FALSE    # Description:
...
L1_CRYSTAL_ON_PMIC_SUPPORT = TRUE
  ...
  # Option Values:
  #   TRUE: enable Crystal on PMIC feature
  #   FALSE: disable Crystal on PMIC feature
  # Switch-ability:
  #   Non-switchable
...
DSP_IMG_ON_EMI = FALSE
  # Description:
  #   DSP image is loaded by AP and put whole DSP image on EMI before MD ungated. 
  #   Note: The buffer for DSP image loading uses the DSP log buffer.
  # Option Values:
  #   TRUE: DSP image is loaded by AP and placed on EMI before MD ungated
  #   FALSE: DSP image is on demand loading
  # Switch-ability:
  #   Non-switchable
...
GERAN_RELEASE_SUPPORT = GERAN_R11_SUPPORT    # Description:
                                             # The option is to switch different version of release for 2G modem
                                             # The GERAN UE capability is also affected by anther option  __2G_CAP_FORCE_R9__
                                             # Option Values:
...
ORIGINAL_FLAVOR = LWCTG_MP5_6757
  # Description:
...
SLIM_DSP_LOGGING = FALSE
  ...
  # Option Values:
  #   TRUE: Slim DSP logging is turned on. DSP logging buffer size is set to 1.5M
  #   FALSE: Slim DSP logging is turned off. DSP logging buffer size is set to the default value 2.1M.
  # Switch-ability:
  #   Non-switchable
...
ORIGINAL_VERNO = MOLY.LR11.W1630.MD.MP.V32.5

VERNO = LR11.W1630.MD.MP.W17.27.LTE.P5
