...
ORIGINAL_FLAVOR = SRLTE_V2_6757P
  # Description:
...
TX_TAS_ENABLE=TRUE
  ...
  # Switch-ability:
  #   Non-switchable
SYS_DAT_SUPPORT=FALSE
  # Description:
  #   dynamic antenna/tuner selection by AP EVENT
  # Option Values:
  #   TRUE:  Enable DAT (Transmit Antenna Selection)
  #   FALSE: Disable DAT
  # Switch-ability:
  #   Non-switchable
EN_32KLESS=TRUE
...
# Description:
#   Enable SAR TX POWER BACKOFF
# Option Values:
#   TRUE:  Enable SAR TX POWER BACKOFF
#   FALSE: Disable SAR TX POWER BACKOFF
# Switch-ability:
#   Non-switchable
