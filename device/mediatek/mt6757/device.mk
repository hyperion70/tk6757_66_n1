...
ifeq ($(strip $(MTK_RC_TO_VENDOR)), yes)
  ...
  PRODUCT_COPY_FILES += device/mediatek/mt6757/ueventd.mt6757.rc:$(TARGET_COPY_OUT_VENDOR)/ueventd.rc
else
...
ifeq ($(MTK_CAM_STEREO_CAMERA_SUPPORT),yes)
    PRODUCT_COPY_FILES += device/mediatek/mt6757/media_profiles_ducam.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles_V1_0.xml:mtk
else
    PRODUCT_COPY_FILES += device/mediatek/mt6757/media_profiles.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_profiles_V1_0.xml:mtk
endif
...
PRODUCT_PACKAGES += thermal.mt6757
...
PRODUCT_PACKAGES += audio.r_submix.mt6757
...
PRODUCT_PACKAGES += powercontable_t.cfg
...
PRODUCT_COPY_FILES += device/mediatek/mt6757/init.mt6757.rc:$(MTK_TARGET_VENDOR_RC)/init.mt6757.rc
PRODUCT_COPY_FILES += device/mediatek/mt6757/factory_init.rc:$(MTK_TARGET_VENDOR_RC)/factory_init.rc
PRODUCT_COPY_FILES += device/mediatek/mt6757/init.modem.rc:$(MTK_TARGET_VENDOR_RC)/init.modem.rc

ifeq ($(strip $(MTK_SENSORS_1_0)),yes)
PRODUCT_COPY_FILES += device/mediatek/mt6757/init.sensor_1_0.rc:$(MTK_TARGET_VENDOR_RC)/init.sensor_1_0.rc
endif

PRODUCT_COPY_FILES += device/mediatek/mt6757/meta_init.modem.rc:$(MTK_TARGET_VENDOR_RC)/meta_init.modem.rc
PRODUCT_COPY_FILES += device/mediatek/mt6757/meta_init.rc:$(MTK_TARGET_VENDOR_RC)/meta_init.rc
PRODUCT_COPY_FILES += device/mediatek/mt6757/init.mt6757.usb.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.mt6757.usb.rc
PRODUCT_COPY_FILES += device/mediatek/mt6757/init.recovery.mt6757.rc:recovery/root/init.recovery.mt6757.rc
...
ifeq ($(TARGET_BUILD_VARIANT),eng)
    ...
    PRODUCT_COPY_FILES += $(LOCAL_PATH)/thermal.fdvrgis.6757_noBCCT.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/.thermal_policy_02:mtk
...
PRODUCT_COPY_FILES += device/mediatek/mt6757/media_codecs.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs.xml:mtk

ifneq ($(MTK_BASIC_PACKAGE), yes)
    ifeq ($(strip $(MTK_AUDIO_CODEC_SUPPORT_TABLET)), yes)
        PRODUCT_COPY_FILES += device/mediatek/mt6757/media_codecs_mediatek_audio_tablet.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_audio.xml:mtk
    else
        PRODUCT_COPY_FILES += device/mediatek/mt6757/media_codecs_mediatek_audio_phone.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_audio.xml:mtk
    endif
else
    PRODUCT_COPY_FILES += device/mediatek/mt6757/media_codecs_mediatek_audio_basic.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_audio.xml:mtk
endif

ifeq (yes,$(strip $(MTK_SEC_VIDEO_PATH_SUPPORT)))
    PRODUCT_COPY_FILES += device/mediatek/mt6757/media_codecs_mediatek_video_svp.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_video.xml
    PRODUCT_COPY_FILES += device/mediatek/mt6757/mtk_omx_core_svp.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/mtk_omx_core.cfg:mtk
else
    PRODUCT_COPY_FILES += device/mediatek/mt6757/media_codecs_mediatek_video.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_video.xml:mtk
    PRODUCT_COPY_FILES += device/mediatek/mt6757/mtk_omx_core.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/mtk_omx_core.cfg:mtk
endif

PRODUCT_COPY_FILES += device/mediatek/mt6757/media_codecs_performance.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_performance.xml:mtk
...
PRODUCT_PROPERTY_OVERRIDES += ro.vendor.camera3.zsl.default=100
...
PRODUCT_PACKAGES   += 	kmsetkey.mt6757
endif
...
# Audio HAL
PRODUCT_PACKAGES += \
    android.hardware.audio@4.0-impl-mediatek \
...
PRODUCT_PACKAGES += \
  ...
  vendor.mediatek.hardware.pq@2.2-impl

# MMS HIDL
PRODUCT_PACKAGES += \
  vendor.mediatek.hardware.mms@1.1-service \
  vendor.mediatek.hardware.mms@1.1-impl
